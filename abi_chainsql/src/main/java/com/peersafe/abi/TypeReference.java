 ...
 */
public abstract class TypeReference<T extends com.peersafe.abi.datatypes.Type>
    ...
    public static <T extends com.peersafe.abi.datatypes.Type> TypeReference<T> create(Class<T> cls) {
        return create(cls, false);
    }

    public static <T extends com.peersafe.abi.datatypes.Type> TypeReference<T> create(
     ...
     */
    protected static Class<? extends com.peersafe.abi.datatypes.Type> getAtomicTypeClass(
    ...
    public abstract static class StaticArrayTypeReference<T extends com.peersafe.abi.datatypes.Type>
    ...
    public static TypeReference makeTypeReference(
        ...
        if (!nextSquareBrackets.find()) {
            final Class<? extends com.peersafe.abi.datatypes.Type> typeClass =
        ...
        final Class<? extends com.peersafe.abi.datatypes.Type> baseClass =
