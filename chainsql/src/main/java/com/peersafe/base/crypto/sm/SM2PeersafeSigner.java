 ...
 *
 *  1 with no userID
 *  2 do not compute sm3
 */
public class SM2PeersafeSigner
        implements Signer, ECConstants
{
    ...
    public SM2PeersafeSigner(Digest digest)
    {
        this(StandardDSAEncoding.INSTANCE, digest);
    }

    public SM2PeersafeSigner(DSAEncoding encoding)
    {
        this.encoding = encoding;
        this.digest = new SM3Digest();
    }

    public SM2PeersafeSigner(DSAEncoding encoding, Digest digest)
    {
        this.encoding = encoding;
        this.digest = digest;
    }
